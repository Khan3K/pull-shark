...
|-------|---------|-------------|-------|------------|--------|
| 🦈 **Pull Shark** | <img src="https://github.githubassets.com/images/modules/profile/achievements/pull-shark-default.png" width="48"/> | Merge at least **2 pull requests** | 4 | 🟡 Medium | ✅ |
| ⭐ **Starstruck** | <img src="https://github.githubassets.com/images/modules/profile/achievements/starstruck-default.png" width="48"/> | A repo you own reaches **16 stars** | 4 | 🔴 Hard | ✅ |
| 🧠 **Galaxy Brain** | <img src="https://github.githubassets.com/images/modules/profile/achievements/galaxy-brain-default.png" width="48"/> | **2 answers accepted** in Discussions | 4 | 🟡 Medium | ⚠️ |
| 👥 **Pair Extraordinaire** | <img src="https://github.githubassets.com/images/modules/profile/achievements/pair-extraordinaire-default.png" width="48"/> | **Co-author a commit** in a merged PR | 4 | 🔴 Hard | ✅ |
| ⚡ **Quickdraw** | <img src="https://github.githubassets.com/images/modules/profile/achievements/quickdraw-default.png" width="48"/> | Close an issue/PR **within 5 min** | — | 🟢 Very Easy | ✅ |
| 😎 **YOLO** | <img src="https://github.githubassets.com/images/modules/profile/achievements/yolo-default.png" width="48"/> | Merge a PR **without review** | — | 🟢 Easy | ✅ |
| 💖 **Public Sponsor** | <img src="https://github.githubassets.com/images/modules/profile/achievements/public-sponsor-default.png" width="48"/> | **Publicly sponsor** via [Sponsors](https://github.com/sponsors) | — | 🟢 Very Easy | ✅ |
| 💗 **Heart On Your Sleeve** | <img src="https://github.githubassets.com/images/modules/profile/achievements/heart-on-your-sleeve-default.png" width="48"/> | React with ❤️ on GitHub | — | 🟢 Very Easy | 🧪 |
| 🌐 **Open Sourcerer** | <img src="https://github.githubassets.com/images/modules/profile/achievements/open-sourcerer-default.png" width="48"/> | PRs merged in **>1 public repo** | — | 🟡 Medium | 🧪 |
...
|------|-------|-----|--------|
| 🥉 Bronze | `x2` | `#F9BFA7` | ![#F9BFA7](https://img.shields.io/badge/-%23F9BFA7-yellow?style=flat-square&color=F9BFA7) |
| 🥈 Silver | `x3` | `#E1E4E4` | ![#E1E4E4](https://img.shields.io/badge/-%23E1E4E4-yellow?style=flat-square&color=E1E4E4) |
| 🥇 Gold | `x4` | `#FAE57E` | ![#FAE57E](https://img.shields.io/badge/-%23FAE57E-yellow?style=flat-square&color=FAE57E) |
...
|-------|---------|-------------------|------|
| **Arctic Code Vault Contributor** | <img src="https://github.githubassets.com/images/modules/profile/achievements/arctic-code-vault-contributor-default.png" width="56"/> | Contributed code archived in the 2020 [GitHub Archive Program](https://archiveprogram.github.com/) (stored in Arctic World Archive, Svalbard). | Feb 2020 |
| **Mars 2020 Contributor** | <img src="https://github.githubassets.com/images/modules/profile/achievements/mars-2020-contributor-default.png" width="56"/> | Contributed code used in NASA's [Mars 2020 Helicopter Mission (Ingenuity)](https://github.com/readme/featured/nasa-ingenuity-helicopter). | Apr 2021 |
...
|-------|----------|---------|
| Stars | `https://img.shields.io/github/stars/Khan3K/pull-shark?style=social` | ![Stars](https://img.shields.io/github/stars/Khan3K/pull-shark?style=social) |
| Forks | `…/forks/…?style=social` | ![Forks](https://img.shields.io/github/forks/Khan3K/pull-shark?style=social) |
| Issues | `…/issues/Khan3K/pull-shark` | ![Issues](https://img.shields.io/github/issues/Khan3K/pull-shark) |
| PRs | `…/issues-pr/Khan3K/pull-shark` | ![PRs](https://img.shields.io/github/issues-pr/Khan3K/pull-shark) |
| Last commit | `…/last-commit/Khan3K/pull-shark` | ![Last commit](https://img.shields.io/github/last-commit/Khan3K/pull-shark) |
| License | `…/license/Khan3K/pull-shark` | ![License](https://img.shields.io/github/license/Khan3K/pull-shark) |
| Repo size | `…/repo-size/Khan3K/pull-shark` | ![Repo size](https://img.shields.io/github/repo-size/Khan3K/pull-shark) |
...
![Forks](https://img.shields.io/github/forks/Khan3K/pull-shark?style=social)
![Issues](https://img.shields.io/github/issues/Khan3K/pull-shark)
![Pull Requests](https://img.shields.io/github/issues-pr/Khan3K/pull-shark)
```

**Build & CI**
```markdown
![Build](https://img.shields.io/github/actions/workflow/status/Khan3K/pull-shark/ci.yml)
![Build](https://img.shields.io/badge/build-passing-brightgreen)
```

**Version & License**
```markdown
![License](https://img.shields.io/github/license/Khan3K/pull-shark)
...
![Commit Activity](https://img.shields.io/github/commit-activity/m/Khan3K/pull-shark)
![Contributors](https://img.shields.io/github/contributors/Khan3K/pull-shark)
```
...
```
Example: `https://img.shields.io/badge/status-active-brightgreen` → ![status](https://img.shields.io/badge/status-active-brightgreen)

### Colors

| Color | Code | Preview |
|-------|------|---------|
| Bright Green | `brightgreen` | ![brightgreen](https://img.shields.io/badge/-brightgreen-brightgreen) |
| Green | `green` | ![green](https://img.shields.io/badge/-green-green) |
| Yellow | `yellow` | ![yellow](https://img.shields.io/badge/-yellow-yellow) |
| Orange | `orange` | ![orange](https://img.shields.io/badge/-orange-orange) |
| Red | `red` | ![red](https://img.shields.io/badge/-red-red) |
| Blue | `blue` | ![blue](https://img.shields.io/badge/-blue-blue) |
| Light Grey | `lightgrey` | ![lightgrey](https://img.shields.io/badge/-lightgrey-lightgrey) |
| Grey | `grey` | ![grey](https://img.shields.io/badge/-grey-grey) |
| Hex | `ff69b4` | ![ff69b4](https://img.shields.io/badge/-ff69b4-ff69b4) |
